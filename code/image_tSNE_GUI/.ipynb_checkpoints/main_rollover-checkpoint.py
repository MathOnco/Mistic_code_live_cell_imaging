...
#for tooltip
#print(pat_id_mt)
#commented out below 2 loc 24th jan 2022
...
def draw_tSNE_scatter(tsne1, file_name_hover):
    ...
    '''
    file_name_hover1=[]
    fl=len(file_name_hover)
    for i in range(fl):
        file_name_hover1=file_name_hover[fl].split("_tiles/")[1]
    '''        
    ### end 24 jan 2022    
    ...
    if (rb_shf_val == 0):
        ...
        for k in range(len(inds)):
            ...
            if(rb_val==0): 
                ...
                '''
                #25th jan 2022 commented above, added below
                #uni_resp_,counts_resp_ = np.unique(resp_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx = np.int(np.array(np.where(resp_list[inds[k]]==uni_resp_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec[cx])
                #print(color_vec)
                ...
                #25th jan 2022 commented above, added below
                #uni_tmt_,counts_tmt_ = np.unique(tx_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx = np.int(np.array(np.where(tx_list[inds[k]]==uni_tmt_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec_tx[cx])
                ...
                #25th jan 2022 commented above, added below
                #uni_clust_,counts_clust_ = np.unique(clust_asgn_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx =  np.int(np.array(np.where(clust_asgn_list[inds[k]]==uni_clust_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec_clasgn[cx])
                #print(cx)
                ...
                #25th jan 2022 commented above, added below
                #uni_pat_,counts_pat_ = np.unique(clust_patid_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx = np.int(np.array(np.where(clust_patid_list[inds[k]]==uni_pat_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec_patid[cx])
    ...
    ##code for reshuffling
        ...
        for k in range(N):
            ...
            if(rb_val==0): 
                ...
                #uni_resp_,counts_resp_ = np.unique(resp_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx = np.int(np.array(np.where(resp_list[shf_N[k]]==uni_resp_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(colours_resp[cx])
                ...
                #uni_tmt_,counts_tmt_ = np.unique(tx_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx = np.int(np.array(np.where(tx_list[shf_N[k]]==uni_tmt_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec_tx[cx])
                ...
                #uni_clust_,counts_clust_ = np.unique(clust_asgn_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx =  np.int(np.array(np.where(clust_asgn_list[shf_N[k]]==uni_clust_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec_clasgn[cx])
                #print(cx)
                ...
                #uni_pat_,counts_pat_ = np.unique(clust_patid_list,return_counts=True)
                #for i in range(len(uni_resp_)):
                #cx = np.int(np.array(np.where(clust_patid_list[shf_N[k]]==uni_pat_)).flatten()) #if(resp_list[inds[k]] == 'Response 1'):
                #print('##################')
                #print(color_vec_patid[cx])
...
def create_figure():
    ...
    if(len(chk_box_marker)==0):
        ...
        file_name_hover = list(range(12)) #19th Jan 2022
